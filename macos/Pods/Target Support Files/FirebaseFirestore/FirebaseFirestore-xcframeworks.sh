...
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/FirebaseFirestore.xcframework" "FirebaseFirestore" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/gRPC-Core.xcframework" "gRPC-Core" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/gRPC-C++.xcframework" "gRPC-C++" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/BoringSSL-GRPC.xcframework" "BoringSSL-GRPC" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/abseil.xcframework" "abseil" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/FirebaseFirestore/FirebaseFirestore/leveldb-library.xcframework" "leveldb-library" "framework" "macos-arm64_x86_64"
